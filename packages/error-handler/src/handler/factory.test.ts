...
describe("createErrHandlerMiddleware", () => {
  ...
  it("should construct ErrorHandler with the correct strategies", () => {
    ...
    expect(ZodErrorSerializer).toHaveBeenCalledTimes(1);
    ...
    expect(ZodErrorhandlerStrategy).toHaveBeenCalledWith(
      expect.any(ZodErrorSerializer),
      mockLogger
    );
    ...
    expect(ErrorHandler).toHaveBeenCalledWith([
      ...
      expect.any(ZodErrorhandlerStrategy),
